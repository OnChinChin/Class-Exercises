...
namespace ChessGame
{
    class ChessBoard
    {
        ...
        public ChessBoard()
        {
            ...
            board[0, 3] = new ChessPieceQueen(this, EChessSide.WHITE, 0, 3);
            board[0, 4] = new ChessPieceKing(this, EChessSide.WHITE, 0, 4);
            ...
            board[7, 3] = new ChessPieceKing(this, EChessSide.BLACK, 7, 3);
            board[7, 4] = new ChessPieceQueen(this, EChessSide.BLACK, 7, 4);
